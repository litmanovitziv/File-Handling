...
/**
 *  get_section_name - given an index into the section header table,
 * 			return the associated section's name.
 *  @index - the requested index.
 *  @start - the start of the file's memory map.
 *
...
/**
 *   get_symbol - given a symbol name,
 * 		  return the appropriate entry in the symbol table
 *   
 *   @name - the name we wish to look for.
 *   @start - the start of the file's memory map.
 *
